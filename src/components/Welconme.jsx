...
const Card = () => {
  ...
  return (
    <div className="flex md:flex-row flex-col justify-between bg-white rounded-lg overflow-hidden">
      ...
      <div className="md:w-[25rem] flex-auto p-6">
        <div className="flex flex-wrap">
          <h1 className=" flex-auto text-xl font-semibold">
            { dynamicWelconmeText }
            <span className={`text-2xl ${isCursorFlicker && 'cursor-flicker'}`}>|</span>
          </h1>
          <div className="text-xl font-semibold text-gray-500 ease-in-out transition-1">
            基于React框架
          </div>
        ...
        <div className="flex space-x-3 mb-4 text-sm font-medium">
          <div className="flex-auto flex space-x-3">
            <button className="w-1/2 flex items-center justify-center rounded-md bg-purple-600 text-white" type="button">Decorative buttons</button>
            <button className="w-1/2 flex items-center justify-center rounded-md border bg-purple-300 text-purple-700" type="button">Decorative buttons</button>
          </div>
